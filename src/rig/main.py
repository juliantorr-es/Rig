...
def build_parser(helpers: RigHelpers) -> argparse.ArgumentParser:
    ...
    commands_diff.register(subparsers, helpers)
    commands_product.register(subparsers, helpers)
    commands_execute.register(subparsers, helpers)

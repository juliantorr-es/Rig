...
PLACEHOLDER_PROVIDER_ID = "no_provider"
PLACEHOLDER_INVOCATION = "no_invocation"
PLACEHOLDER_INVOKE_ID = "INVOKE_ID_PLACEHOLDER"  # Matches runtime_replay.py
PLACEHOLDER_MODEL_ID = "no_model"
...
DEFAULT_MAX_CHUNK_BYTES = DEFAULT_MAX_CHUNK_SIZE
DEFAULT_MAX_BUFFER_BYTES = DEFAULT_MAX_BUFFER_SIZE

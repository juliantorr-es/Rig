...
export const DTG_COLORS = {
  // Node colors by kind
  NODE_ROOT: '#4CAF50',
  NODE_PROPOSAL: '#2196F3',
  NODE_DECISION: '#FF9800',
  NODE_ROUTING: '#9C27B0',
  NODE_INTEGRITY: '#F44336',
  NODE_EXECUTION: '#8BC34A',
  NODE_BRANCH: '#FFC107',
  NODE_MERGE: '#607D8B',
  NODE_SUPERVISION: '#E91E63',
  NODE_CAPABILITY: '#3F51B5',
  NODE_REPLAY: '#00BCD4',
  NODE_TERMINAL: '#795548',
  
  // Node colors by state
  NODE_PENDING: '#9E9E9E',
  NODE_ACTIVE: '#2196F3',
  NODE_ACCEPTED: '#4CAF50',
  NODE_REJECTED: '#F44336',
  NODE_EXECUTING: '#FF9800',
  NODE_COMPLETE: '#8BC34A',
  NODE_FAILED: '#F44336',
  NODE_STALLED: '#795548',
  NODE_INTEGRITY_OK: '#4CAF50',
  NODE_INTEGRITY_WARNING: '#FFC107',
  NODE_INTEGRITY_ERROR: '#F44336',
  
  // Edge colors by kind
  EDGE_PROPOSAL: '#2196F3',
  EDGE_ACCEPT: '#4CAF50',
  EDGE_REJECT: '#F44336',
  EDGE_ROUTE: '#9C27B0',
  EDGE_ESCALATE: '#FF5722',
  EDGE_SUPERVISE: '#E91E63',
  EDGE_INTEGRITY_CHECK: '#4CAF50',
  EDGE_INTEGRITY_VIOLATION: '#F44336',
  EDGE_REPLAY_LINK: '#00BCD4',
  EDGE_CAPABILITY: '#3F51B5',
  EDGE_SEQUENCE: '#607D8B',
  EDGE_ALTERNATIVE: '#FFC107',
  
  // Edge colors by state
  EDGE_ACTIVE: '#2196F3',
  EDGE_INACTIVE: '#9E9E9E',
  EDGE_COMPLETE: '#4CAF50',
  EDGE_FAILED: '#F44336',
  EDGE_STALLED: '#795548',
  EDGE_VIOLATED: '#F44336',
  EDGE_VERIFIED: '#4CAF50',
  EDGE_SUPERVISED: '#E91E63',

...
class ActionRegistry:
    def __init__(self, repo_root: Path):
        ...
        self.rig_module = [self.python, "-m", "rig"]
    ...
    def _register_defaults(self):
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "monitor", "snapshot"],
            accepts_task=False,
            requires_task=False,
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "prompt", "status"],
            accepts_task=False,
            requires_task=False,
            allowed_modes=["safe", "action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "agent", "status"],
            accepts_task=False,
            requires_task=False,
            allowed_modes=["safe", "action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "schema", "validate", "--family", "rig.result.v1"],
            accepts_task=False,
            requires_task=False,
            allowed_modes=["safe", "action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "context", "build", "--purpose", "loop-planner", "--max-chars", "16000"],
            accepts_task=True, 
            requires_task=True,
            allowed_modes=["safe", "action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "loop", "plan", "--backend", "mlx", "--model", "mlx-community/Qwen3-4B-Instruct-2507-4bit"],
            accepts_task=True, 
            requires_task=True,
            allowed_modes=["safe", "action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "agent", "plan", "--backend", "mlx", "--model", "mlx-community/Qwen3-4B-Instruct-2507-4bit"],
            accepts_task=True, 
            requires_task=True,
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "bundle", "session", "--dry-run"],
            accepts_task=True, 
            requires_task=True,
            allowed_modes=["safe", "action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "queue", "add", "--mode", "read-only", "--max-steps", "3"],
            accepts_task=True, 
            requires_task=True,
            allowed_modes=["action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "queue", "run", "--max-jobs", "1"],
            accepts_task=False,
            requires_task=False,
            allowed_modes=["action", "auto-approve"],
            requires_confirmation=False
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "bundle", "session"],
            accepts_task=True, 
            requires_task=True,
            allowed_modes=["action", "auto-approve"],
        ...
        self.register(ActionDefinition(
            ...
            argv_template=[*self.rig_module, "git", "commit-plan"],
            accepts_task=True, 
            requires_task=True,
            allowed_modes=["action", "auto-approve"],
            requires_confirmation=False,

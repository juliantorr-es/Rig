...
# Plan promotion without mutating the lane
python scripts/rig_agent_worktree.py promote gemini ui-cockpit --path .rig/worktrees/ui-cockpit --dry-run
python scripts/rig_agent_worktree.py promote gemini ui-cockpit --path .rig/worktrees/ui-cockpit --strategy pr --target sprint/ui-cockpit --dry-run
